...
import { Container, InputArea, Button, MessageButtonText, BlockGrup } from './styles';
        ...
        >
            <Container>
                ...
                <InputArea>
                    ...
                    <BlockGrup>
                        <LoginInput placeholder="CEP" setInput={setCep} style={{width: 50}}/>
                    ...
                    <LoginInput placeholder="Confirmar senha" setInput={setConfirmarSenha}/>
